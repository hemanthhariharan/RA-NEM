...
The folder 'Variable_volume_swap_valuation' contains the code used for pricing the swap, with more details on the use of various statistical methods.
...
'Options_valuation.ipynb' contains implementations of functions for modeling European and American options (binomial tree), variable-volume swap Greeks, Geometric Brownian Motion, Value at Risk (VaR) etc.
